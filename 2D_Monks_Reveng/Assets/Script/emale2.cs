...
public class Emale2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (animator == null)
        {
            Debug.LogError("Animator component missing from the Emale2 GameObject.");
        }
        else
        {
    ...
    IEnumerator Patrol()
    {
        while (true)
        {
            ...
            if (animator != null)
            {
                animator.SetBool("runA1", false); // Set idle animation
            }
            ...
            if (animator != null)
            {
                animator.SetBool("runA1", true); // Set running animation
            }
